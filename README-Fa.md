...
- برای پیکربندی بهینه، پورت‌هایی بین 54 و 65535 را انتخاب کنید.
- پیشنهادات شما برای بهبود و تقویت اسکریپت بسیار خوش‌آمد است. ایده‌های خود را در [مخزن GitHub](https://github.com/your-username/gost-ip6-script) به اشتراک بگذارید.
